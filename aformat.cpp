...
void AFormat::ptrHandle(char *&tempBuffer, formatInfo &info, arg &args, cBuffer &tempStr)
{
...
void AFormat::octHandle(char *&tempBuffer, formatInfo &info, arg &args, cBuffer &tempStr)
{
...
void AFormat::hexHandle(char *&tempBuffer, formatInfo &info, arg &args, cBuffer &tempStr)
{
	char *container = tempStr.data();
...
void AFormat::floatHandle(char *&tempBuffer, formatInfo &info, arg &args, cBuffer &tempStr)
{
	char *container = tempStr.data();
...
void AFormat::chHandle(char *&tempBuffer, formatInfo &info, arg &args, cBuffer &tempStr)
{
...
void AFormat::integerHandle(char *&tempBuffer, formatInfo &info,arg &args,cBuffer &tempStr)
{
	char *container = tempStr.data();
